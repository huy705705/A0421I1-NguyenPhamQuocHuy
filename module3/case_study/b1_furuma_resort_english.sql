...
foreign key (education_degree_id) references eduaction_degree(eduaction_degree_id),
...
create table  eduaction_degree(
eduaction_degree_id int primary key auto_increment,
eduaction_degree_name varchar(45)
);
